    ...
    <section class="text-gray-600 body-font">
      ...
      <div class="flex flex-wrap -m-4">
        <div class="p-4 md:w-1/3">
          <div class="h-full bg-white shadow-xl rounded-xl dark:bg-gray-900 overflow-hidden">
              <ul >
                 {blok.posts.map((post) => {
                   ...
                   return (
                     <li key={post.content._uid} >
                       ...
                       >
                          <img class="lg:h-48 md:h-36 w-full object-cover object-center" src={post.content.image}  alt="blog"/>
                            <div class="p-6">
