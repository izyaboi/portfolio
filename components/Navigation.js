   ...
   <nav className="" role="navigation">
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          ...
          <span className="ml-3 text-xl text-black body-font dark:text-white dark:bg-gray-800" >Tristan Hubel [Dev]elopment</span>
        </a>
      <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
        <a className="mr-5 hover:text-white" href="/">Home</a>
        <a className="mr-5 hover:text-white" href={`/${language}/blog`}>Blog</a>
      </nav>
